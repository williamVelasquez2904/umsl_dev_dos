...
<html lang="en">
	...
	<body class="login-layout" style="background:#5d5d5d">
		...
		<div class="col-sm-12" style="background:#FFFFFF">
			...
			<h2 class="pull-left" style="padding-left:30px">
				<span class="inverse"><?php echo "UNIDAD MEDICA SAN LUIS" ?></span>
				<div class="space-0"></div>
				<span class="inverse"><?php echo "Control Epidemiológico" ?></span>
			</h2>
		</div>
		<div class="clearfix"></div>
							...
							<div class="position-relative">
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main" style="background:#F47100">
											<h5 class="header white lighter bigger">
												<!--<i class="icon-coffee green"></i>-->
												<b>INDIQUE LOS DATOS DE ACCESO</b>
											</h5>
											<div class="msj"></div>
											<div class="space-6"></div>
										...
										<div class="toolbar clearfix" style="background:#d2d2d2">
											<div>
											</div>
										</div>
									</div><!-- /widget-body -->
